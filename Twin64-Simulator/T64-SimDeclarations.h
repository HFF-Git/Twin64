...
enum SimErrMsgId : int {
    ...
    ERR_NOT_INTERACTIVE             = 3,
    ERR_TOO_MANY_ARGS_CMD_LINE      = 4,
    ERR_CMD_LINE_TOO_LONG           = 5,
    ERR_EXTRA_TOKEN_IN_STR          = 6,
...
struct SimWinMem : SimWinScrollable {
    ...
    void            drawMemDataLine32( T64Word itemAdr, uint32_t fmtDesc );
    void            drawMemDataLine64( T64Word itemAdr, uint32_t fmtDesc );
